    ...
    <div className="min-h-screen bg-white text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          <a href="#top" className="flex items-center rounded-2xl transition hover:opacity-95" aria-label="Accueil ProprioSécur">
            <div className="rounded-2xl bg-white px-2 py-1 shadow-sm ring-1 ring-slate-200 sm:px-3 sm:py-2">
              <img
          ...
          <div className="hidden items-center gap-6 md:flex">
            <a href="#top" className="text-sm font-medium text-slate-600 hover:text-slate-900">Accueil</a>
            
            <a href="#services" className="text-sm font-medium text-slate-600 hover:text-slate-900">Services</a>
            <a href="#processus" className="text-sm font-medium text-slate-600 hover:text-slate-900">Processus</a>
            <a href="#faq" className="text-sm font-medium text-slate-600 hover:text-slate-900">FAQ</a>
            <a href="#blog" className="text-sm font-medium text-slate-600 hover:text-slate-900">Blog</a>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto mb-12 max-w-6xl px-6">
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-[2rem] border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-6 shadow-sm">
              <div className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-700">Avis Google</div>
              <div className="mt-3 flex items-center gap-3">
                <div className="text-4xl font-extrabold text-slate-900">4.9</div>
                <div>
                  <div className="text-xl text-amber-500">★★★★★</div>
                  <div className="text-sm text-slate-500">Évaluation moyenne estimative</div>
                </div>
              </div>
              <p className="mt-4 leading-7 text-slate-600">
                Les propriétaires recherchent un service rapide, humain et confidentiel. Les avis et témoignages renforcent la confiance et facilitent la prise de contact.
              </p>
            </div>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              <div className="flex items-center gap-4">
                <div className="rounded-2xl bg-white px-3 py-2 shadow-sm ring-1 ring-slate-200">
                  <img src="/propriosecur_logo_hd.png" alt="ProprioSécur" className="h-10 w-auto object-contain" />
                </div>
                <div>
      ...
      {isPopupOpen && !isChatOpen && (
        <div className="fixed inset-0 z-[55] flex items-end justify-center bg-slate-950/40 p-4 md:items-center backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-[2rem] bg-white p-8 shadow-2xl ring-1 ring-slate-200">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="text-sm font-semibold uppercase tracking-[0.2em] text-green-600">Analyse gratuite</div>
                <h3 className="mt-2 text-2xl font-bold text-slate-900">Avez-vous reçu un préavis de 60 jours?</h3>
                <p className="mt-3 leading-7 text-slate-600">
                  Si votre situation est urgente, nous pouvons analyser rapidement votre dossier et vous orienter vers une solution adaptée.
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <a href="#contact" onClick={() => setIsPopupOpen(false)} className="inline-flex justify-center rounded-2xl bg-red-600 px-6 py-4 text-base font-semibold text-white shadow-sm transition hover:bg-red-700">
                FAIRE UNE DEMANDE EN LIGNE
              </a>
              <button
                type="button"
